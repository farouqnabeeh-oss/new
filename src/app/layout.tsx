  ...
  return (
    <html lang={lang} dir={isAr ? "rtl" : "ltr"} suppressHydrationWarning>
      ...
      <body suppressHydrationWarning>
        ...
        <Script src="/js/language.js?v=12" strategy="beforeInteractive" />
        <Script src="/js/cart.js?v=12" strategy="beforeInteractive" />
        <Script src="/js/ui.js?v=12" strategy="afterInteractive" />
