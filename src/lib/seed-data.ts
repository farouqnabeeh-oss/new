...
export async function seedRestaurantData() {
  ...
  const products = [
    ...
    { name_ar: "آيس كريم", name_en: "Ice Cream", description_ar: "3 سكوپ من نكهاتك المفضلة", description_en: "3 scoops of your favorite flavors", base_price: 15, discount: 0, category_id: categoryMap["Desserts"], is_active: true, all_branches: true, image_path: "/images/ice-cream__ve92ex3v6cb5ol6.jpg" },
    { name_ar: "سان سباستيان تشيز كيك", name_en: "San Sebastian Cheesecake", description_ar: "تشيز كيك سان سباستيان الكريمي", description_en: "Creamy San Sebastian cheesecake", base_price: 30, discount: 0, category_id: categoryMap["Desserts"], is_active: true, all_branches: true, image_path: "/images/san-sebastian-cheesecake__crjozhzu3bx2i1k.jpg" },
    { name_ar: "بلوبيري تشيز كيك", name_en: "Blueberry Cheesecake", description_ar: "تشيز كيك بلمسة بلوبيري", description_en: "Cheesecake with a blueberry touch", base_price: 22, discount: 0, category_id: categoryMap["Desserts"], is_active: true, all_branches: true, image_path: "/images/blueberry-cheesecake__163xoiwy7wlrfjb.jpg" },
    { name_ar: "لوتس تشيز كيك", name_en: "Lotus Cheesecake", description_ar: "تشيز كيك بطبقة اللوتس", description_en: "Cheesecake with a lotus layer", base_price: 22, discount: 0, category_id: categoryMap["Desserts"], is_active: true, all_branches: true, image_path: "/images/lotus-cheesecake__dy0dgdb9jiizmu3.jpg" },
    ...
    { name_ar: "موميتو", name_en: "Mojito", description_ar: "موهيتو منعش للموميتو", description_en: "Refreshing mojito drink", base_price: 17, discount: 0, category_id: categoryMap["Cold Drinks"], is_active: true, all_branches: true, image_path: "/images/mojito__dnldrs18pec0our.jpg" },
    { name_ar: "عصير", name_en: "Juice", description_ar: "عصير فواكه طازج", description_en: "Fresh fruit juice", base_price: 16, discount: 0, category_id: categoryMap["Cold Drinks"], is_active: true, all_branches: true, image_path: "/images/juice__xe7kdad5ruvmdwq.jpg" },
    ...
    { name_ar: "ريب أي بيرجر", name_en: "Ribeye Burger", description_ar: "150 غرام . قطعة كلاسيك . شرائح ستيك ريب أي 60 غرام . خس . بندورة . بصل . جبنة", description_en: "150g patty + ribeye strips, lettuce, tomato, onions, cheese", base_price: 45, discount: 0, category_id: categoryMap["Burgers"], is_active: true, all_branches: true, has_meal_option: true, image_path: "/images/ribeye-burger__8w4my5hb4xqt6zg.jpg" },
    ...
    // Appetizers
    { name_ar: "أصابع موزاريلا", name_en: "Mozzarella Sticks", description_ar: "أصابع جبنة موزاريلا مقلية", description_en: "Deep fried mozzarella cheese sticks", base_price: 4, discount: 0, category_id: categoryMap["Appetizers"], is_active: true, all_branches: true, image_path: "/images/mozzarella-sticks-3-pcs__ilg2wr1vbnhdqns.jpg" },
